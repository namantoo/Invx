...
// }, []);
  ...
  // console.log(selectedexp.name)
  const [portfsize, setPortfsize] = useState(portfoliosize[0]);
  // console.log(portfsize.name)
  ...
  { 
      ...
      bodyFormData.append('fullName', fname);
      bodyFormData.append('country', country);
      bodyFormData.append('code', code);
      bodyFormData.append('pnumber', pnumber);
      bodyFormData.append('texp', selectedexp.name);
      bodyFormData.append('holdings', portfsize.name);
      axios(
          {
              method: 'POST',
              url: `${napi}/profile`,
          ...
          .then((response) => {
              ...
              sessionStorage.setItem("phone_number", pnumber); 
                    ...
                    <div>
                        ...
                        <div className="mt-2 flex rounded-md shadow-sm">
                          ...
                          <input
                            ...
                            name="email" onChange={(e) => setFname(e.target.value)}
